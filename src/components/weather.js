...
const weather =(props) =>{
    return(
        <div className="info">
           {props.temperature && <p className="info-key">☁️temperature:
           <span className="info-value">{props.temperature}</span> 
           </p>}  
           {props.city && <p >
           <span className="info-city">{props.city}.</span> 
           </p>} 
           {props.country && <p className="info-key">☁️country:
           <span className="info-value">{props.country}</span> 
           </p>} 
           {props.humidity && <p className="info-key">☁️humidity:
           <span className="info-value">{props.humidity}</span> 
           </p>} 
           {props.description && <p className="info-key">☁️description:
